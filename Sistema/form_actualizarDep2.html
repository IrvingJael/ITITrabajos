...
<head>
	...
	<title>Actualizar Lista de Departamentos</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-office mr-2"></i> <span class="font-weight-semibold">Departamentos</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							<a href="index.html" class="breadcrumb-item"><i class="icon-office mr-2"></i>Departamentos</a>
							<span class="breadcrumb-item active">Actualizar Departamentos</span>
						</div>
		        ...
		        <div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Actualizar Departamentos</h5>
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>A03</td>
									<td>Administracion y Recursos Humanos</td>
									<td>Cd Victoria</td>
									<td>8341222001</td>
									<td>AdminRecursos@gmail.com</td>
								</tr>
								<tr>
									<th>
										<!-- Botones que abren los modales -->
						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="A01"></td>
											<td><input type="text" class="form-control" value="Direccion General"></td>
											<td><input type="text" class="form-control" value="Cd Victoria"></td>
											<td><input type="text" class="form-control" value="8341526985"></td>
											<td><input type="text" class="form-control" value="DirecGen@gmail.com"></td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="A02"></td>
											<td><input type="text" class="form-control" value="Auxiliar Administrativo"></td>
											<td><input type="text" class="form-control" value="Cd Victoria"></td>
											<td><input type="text" class="form-control" value="8346989854"></td>
											<td><input type="text" class="form-control" value="AuxAdmin@gmail.com"></td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="A03"></td>
											<td><input type="text" class="form-control" value="Administracion y Recursos Humanos"></td>
											<td><input type="text" class="form-control" value="Cd Victoria"></td>
											<td><input type="text" class="form-control" value="8341222001"></td>
											<td><input type="text" class="form-control" value="AdminRecursos@gmail.com"></td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="A04"></td>
											<td><input type="text" class="form-control" value="Finanzas"></td>
											<td><input type="text" class="form-control" value="Cd Victoria"></td>
											<td><input type="text" class="form-control" value="8340123006"></td>
											<td><input type="text" class="form-control" value="Finan@gmail.com"></td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="A05"></td>
											<td><input type="text" class="form-control" value="Publicidad"></td>
											<td><input type="text" class="form-control" value="Cd Victoria"></td>
											<td><input type="text" class="form-control" value="8341050809"></td>
											<td><input type="text" class="form-control" value="Publi@gmail.com"></td>
										</tr>
									</tbody>
								</table>
							</div>
