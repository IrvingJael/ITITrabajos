...
<head>
	...
	<title>Actualizar Lista de Emleados</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-user-tie mr-2"></i> <span class="font-weight-semibold">Empleados</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							<a href="index.html" class="breadcrumb-item"><i class="icon-user-tie mr-2"></i>Empleados</a>
		         ...
		         <!--Contenido -->
		         <div class="content"> 
				<!-- Formulario de Actualizar Empleados -->
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Actualizar lista de empleados</h5>
					...
					<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="IrvingJael">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Aguilar">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Ciudad:</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="CD Victoria">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Dirección:</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Fracc Las Palomas Paloma Morada #3022">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Correo Electrónico:</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="irving_j_m@hotmail.com">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Teléfono:</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="8342680916">
									<!-- </div> -->
								</div>
							</fieldset>
