...
<head>
	...
	<title>Actualizar listado de Vacaciones</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-map5 mr-2"></i> <span class="font-weight-semibold">Vacaciones</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							<a href="index.html" class="breadcrumb-item"><i class="icon-map5 mr-2"></i>Vacaciones</a>
							<span class="breadcrumb-item active">Actualizar Listado de Vacaciones</span>
						</div>
		         ...
		         <!-- Tabla para editar los campos -->
		        <div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Actualizar Listado De Vacaciones</h5>
						...
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									...
									<th>1</th>
									<th>Irving Jael Martínez Aguilar</th>
									<th>20 de agosto de 2019</th>
									<th>30 de agosto de 2019</th>
									<th>Tampico</th>
								</tr>
								<tr>
									<th>
									...
									<th>3</th>
									<th>Maria Lopéz Rodríguez</th>
									<th>2 de febrero de 2019</th>
									<th>22 de febrero de 2019</th>
									<th>Cuidad de México</th>
								</tr>
								<tr>
									<th>
										<!-- Botones que abren los modales -->
									...
									<th>6</th>
									<th>Jesus Aguilar Medrano</th>
									<th>10 de enero de 2019</th>
									<th>10 de febrero de 2019</th>
									<th>Cancún</th>
								</tr>
								<tr>
									<th>
									...
									<th>10</th>
									<th>Oscar Rodrigez Martínez</th>
									<th>5 de junio de 2019</th>
									<th>5 de julio de 2019</th>
									<th>Tulum</th>
								</tr>
								<tr>
									<th>
									...
									<th>8</th>
									<th>Gabriela Vasquez Mota</th>
									<th>25 de septiembre de 2019</th>
									<th>30 de octubre de 2019</th>
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td><input type="text" class="form-control" value="Irving Jael Martínez Aguilar"></td>
											<td><input type="text" class="form-control" value="20 de agosto de 2019"></td>
											<td><input type="text" class="form-control" value="30 de agosto de 2019"></td>
											<td><input type="text" class="form-control" value="Tampico"></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td><input type="text" class="form-control" value="Maria Lopéz Rodríguez"></td>
											<td><input type="text" class="form-control" value="2 de febrero de 2019"></td>
											<td><input type="text" class="form-control" value="22 de febrero de 2019"></td>
											<td><input type="text" class="form-control" value="Cuidad de México"></td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="modal-content">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="6"></td>
											<td><input type="text" class="form-control" value="Jesus Aguilar Medrano"></td>
											<td><input type="text" class="form-control" value="10 de enero de 2019"></td>
											<td><input type="text" class="form-control" value="10 de febrero de 2019"></td>
											<td><input type="text" class="form-control" value="Cancún"></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td><input type="text" class="form-control" value="Oscar Rodrigez Martínez"></td>
											<td><input type="text" class="form-control" value="5 de junio de 2019"></td>
											<td><input type="text" class="form-control" value="5 de julio de 2019"></td>
											<td><input type="text" class="form-control" value="Tulum"></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td><input type="text" class="form-control" value="Gabriela Vasquez Mota"></td>
											<td><input type="text" class="form-control" value="25 de septiembre de 2019"></td>
											<td><input type="text" class="form-control" value="30 de octubre de 2019"></td>
											<td><input type="text" class="form-control" value="Playa del Carmen"></td>
										</tr>
									</tbody>
								</table>
							</div>
