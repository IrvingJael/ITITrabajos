		         ...
		         <div class="card">
					...
					<div class="card card-body">
							<div class="media align-items-center align-items-md-start flex-column flex-md-row">
								<a href="#" class="text-teal mr-md-3 mb-8 mb-md-0">
									<i class="icon-question7 text-success-400 border-success-400 border-2 rounded-round p-2"></i>
								</a>

								<div class="media-body text-center text-md-left">
									<h6 class="media-title font-weight-semibold">¿Tienes alguna solicitud?</h6>
									Contáctanos directamente en cualquier momento
								</div>

								<a href="#" class="btn bg-warning-400 ml-md-3 mt-3 mt-md-0">Contacto</a>
							</div>
					</div>
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Subscribete</h6>
							...
							<form class="card-body" action="#">
								...
								<div class="form-group">
									<textarea class="form-control" cols="3" rows="3" placeholder="Mensaje"></textarea>
								</div>
								...
								<div class="d-flex align-items-center">
		                    		...
		                    		<button type="button" class="btn bg-blue ml-auto">Subscribete</button>
		                    	</div>
							</form>
						</div>
						...
						<div class="card card-body">
							<div class="row text-center">
								<div class="col-6">
									...
									<span class="text-muted font-size-sm">usuarios</span>
								</div>

								<div class="col-6">
									<p><i class="icon-point-up icon-2x d-inline-block text-warning"></i></p>
									<h5 class="font-weight-semibold mb-0">3,568</h5>
									<span class="text-muted font-size-sm">clics</span>
								</div>
							</div>
						</div>
		         	</div>

		         	<div class="card bg-blue-400 text-white text-center p-3" style="background-image: url(../../../../global_assets/images/backgrounds/panel_bg.png); background-size: contain;">
							<div>
							...
							<blockquote class="blockquote mb-0">
								<p>"La cosa más difícil es conocernos a nosotros mismos; la más fácil es hablar mal de los demás"</p>
								<footer class="blockquote-footer text-white">
									<span>
										 <cite title="Source Title">Tales de Mileto</cite>
									</span>
								</footer>
							</blockquote>
						</div>
						...
						<div class="card card-body">
							<div class="media">
								<div class="media-body">
									<h6 class="media-title font-weight-semibold">Limitless</h6>
									<span class="text-muted">Una gran Herramienta</span>
								</div>

								<div class="ml-3 align-self-center">
									<i class="icon-home2 icon-2x text-blue-300"></i>
								</div>
							</div>
						</div>
				</div>
