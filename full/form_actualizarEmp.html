...
<head>
	...
	<title>Actualizar Lista de Empleados</title>
...
<body>
	...
	<div class="page-content">
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="layouts">
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_lista.html" class="nav-link active">Listado de Empleados</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_empleados.html" class="nav-link active">Añadir Empleado</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_actualizar.html" class="nav-link active">Actualizar el Listado Empleados</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-office"></i> <span>Departamentos</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="layouts">
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_listaDep.html" class="nav-link active">Listado de Departamentos</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_agregarDep.html" class="nav-link active">Agregar Departamento</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_actualizarDep.html" class="nav-link active">Actualizar Departamentos</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-city"></i> <span>Empresas</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="layouts">
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_listaEmp.html" class="nav-link active">Listado de Empresas</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_agregarEmp.html" class="nav-link active">Agregar Empresa</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_actualizarEmp.html" class="nav-link active">Actualizar lista de Empresas</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-map5"></i> <span>Vacaciones</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="layouts">
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_listaVac.html" class="nav-link active">Listado de Vacaciones</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_agregarVac.html" class="nav-link active">Agregar Vacaciones</a></li>
								<li class="nav-item"><a href="../../../../layout_1/LTR/default/full/form_actualizarVac.html" class="nav-link active">Actualizar Lista de Vacaciones</a></li>
							</ul>
						</li>
						<!--
						<li class="nav-item nav-item-submenu">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-city mr-2"></i> <span class="font-weight-semibold">Empresas</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							<a href="index.html" class="breadcrumb-item"><i class="icon-city mr-2"></i>Empresas</a>
							<span class="breadcrumb-item active">Actualizar Listado de Empresas</span>
						</div>
		         ...
		         <div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Actualizar Listado de Empresas</h5>
							...
							<tbody>
								<tr>
									<th>
										...
										<div class="list-icons">
					                		<a href="#" class="list-icons-item text-primary 600" data-toggle="modal" data-target="#edit_modalA01" data-popup="tooltip" title="Editar" data-container="body">
					                			<i class="icon-pencil7"></i>
				                			</a>
					                		<a href="#" class="list-icons-item text-danger 600" data-toggle="modal" data-target="#remove_modal" data-popup="tooltip" title="Eliminar" data-container="body">
									...
									<td>Matehuala - Saltillo, Parque Indutrial, 78700 Matehuala, S.L.P.</td>
									<td>M011108DJ5</td>
									<td>https://www.bimbo.com.mx/es</td>
									<td>+528009102030</td>
									<td>atencionenlinea@grupobimbo.com</td>
									<td>Secundario</td>
								</tr>
								<tr>
									<th>
										<!-- Botones que abren los modales -->
										<div class="list-icons">
					                		<a href="#" class="list-icons-item text-primary 600" data-toggle="modal" data-target="#edit_modalA02" data-popup="tooltip" title="Editar" data-container="body">
					                			<i class="icon-pencil7"></i>
				                			</a>
					                		<a href="#" class="list-icons-item text-danger 600" data-toggle="modal" data-target="#remove_modal" data-popup="tooltip" title="Eliminar" data-container="body">
					                			<i class="icon-trash"></i>
									...
									<td>Mexico</td>
									<td>Ciudad de Mexico</td>
									<td>México-Laredo 85, 79960 Tamazunchale, S.L.P.</td>
									<td>E520101TC7</td>
									<td>https://www.coca-colamexico.com.mx/</td>
									<td>8343167765</td>
									<td>consumidor@coca-cola.com</td>
									<td>Secundario</td>
								</tr>
								<tr>
									<th>
										<!-- Botones que abren los modales -->
										<div class="list-icons">
					                		<a href="#" class="list-icons-item text-primary 600" data-toggle="modal" data-target="#edit_modalA03" data-popup="tooltip" title="Editar" data-container="body">
					                			<i class="icon-pencil7"></i>
				                			</a>
					                		<a href="#" class="list-icons-item text-danger 600" data-toggle="modal" data-target="#remove_modal" data-popup="tooltip" title="Eliminar" data-container="body">
					                			<i class="icon-trash"></i>
									...
									<td>Mexico</td>
									<td>Ciudad de Mexico</td>
									<td>Av Miguel Ángel de Quevedo 227, Oxtopulco, 04310 Ciudad de México</td>
									<td>AVD1521274</td>
									<td>https://cinepolis.com/</td>
									<td>015521226060</td>
									<td>soporte_ef@cinepolis.com</td>
									<td>Terciario</td>
								</tr>
								<tr>
									<th>
										<!-- Botones que abren los modales -->
										<div class="list-icons">
					                		<a href="#" class="list-icons-item text-primary 600" data-toggle="modal" data-target="#edit_modalA04" data-popup="tooltip" title="Editar" data-container="body">
					                			<i class="icon-pencil7"></i>
				                			</a>
					                		<a href="#" class="list-icons-item text-danger 600" data-toggle="modal" data-target="#remove_modal" data-popup="tooltip" title="Eliminar" data-container="body">
					                			<i class="icon-trash"></i>
									...
									<td>Mexico</td>
									<td>Ciudad de Mexico</td>
									<td>Ahuacatitla Numero 96 Colonia Barrio los Reyes Azcapotzalco México, Distrito Federal</td>
									<td>NWM9709244</td>
									<td>http://www.jarritosmexico.com/</td>
									<td>5558994200</td>
									<td>datospersonales@agamexico.com.mx</td>
									<td>Secundario</td>
								</tr>
								<tr>
									<th>
										<!-- Botones que abren los modales -->
										<div class="list-icons">
					                		<a href="#" class="list-icons-item text-primary 600" data-toggle="modal" data-target="#edit_modalA05" data-popup="tooltip" title="Editar" data-container="body">
					                			<i class="icon-pencil7"></i>
				                			</a>
					                		<a href="#" class="list-icons-item text-danger 600" data-toggle="modal" data-target="#remove_modal" data-popup="tooltip" title="Eliminar" data-container="body">
					                			<i class="icon-trash"></i>
									...
									<td>Mexico</td>
									<td>Ciudad de Mexico</td>
									<td>Delegación Miguel Hidalgo, C.P. 11040, Ciudad de México, México.</td>
									<td>AWEF244SDE</td>
									<td>https://rotoplas.com.mx/</td>
									<td>(55)54832950</td>
									<td>contactorotoplas@gmail.com</td>
									<td>Secundario</td>
								</tr>
							</tbody>
						</table>
            ...
            <!-- Modales de Edicion -->
			<div id="edit_modalA01" class="modal fade" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header bg-transparent">
								<h5 class="modal-title">Tabla de Editar</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="E01"></td>
											<td><input type="text" class="form-control" value="Grupo Bimbo"></td>
											<td><input type="text" class="form-control" value="Mexico"></td>
											<td><input type="text" class="form-control" value="Ciudad de Mexico"></td>
											<td><input type="text" class="form-control" value="Matehuala - Saltillo, Parque Indutrial, 78700 Matehuala, S.L.P."></td>
											<td><input type="text" class="form-control" value="M011108DJ5"></td>
											<td><input type="text" class="form-control" value="https://www.bimbo.com.mx/es"></td>
											<td><input type="text" class="form-control" value="+528009102030"></td>
											<td><input type="text" class="form-control" value="atencionenlinea@grupobimbo.com"></td>
											<td><input type="text" class="form-control" value="Secundario"></td>
										</tr>
									</tbody>
								</table>
							</div>
				...
				<div id="edit_modalA02" class="modal fade" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header bg-transparent">
								<h5 class="modal-title">Tabla de Editar</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="E02"></td>
											<td><input type="text" class="form-control" value="Coca Cola"></td>
											<td><input type="text" class="form-control" value="Mexico"></td>
											<td><input type="text" class="form-control" value="Ciudad de Mexico"></td>
											<td><input type="text" class="form-control" value="México-Laredo 85, 79960 Tamazunchale, S.L.P."></td>
											<td><input type="text" class="form-control" value="E520101TC7"></td>
											<td><input type="text" class="form-control" value="https://www.coca-colamexico.com.mx/"></td>
											<td><input type="text" class="form-control" value="8343167765"></td>
											<td><input type="text" class="form-control" value="consumidor@coca-cola.com"></td>
											<td><input type="text" class="form-control" value="Secundario"></td>
										</tr>
									</tbody>
								</table>
                ...
                <div id="edit_modalA03" class="modal fade" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header bg-transparent">
								<h5 class="modal-title">Tabla de Editar</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="E03"></td>
											<td><input type="text" class="form-control" value="Cinepolis"></td>
											<td><input type="text" class="form-control" value="Mexico"></td>
											<td><input type="text" class="form-control" value="Ciudad de Mexico"></td>
											<td><input type="text" class="form-control" value="Av Miguel Ángel de Quevedo 227, Oxtopulco, 04310 Ciudad de México"></td>
											<td><input type="text" class="form-control" value="AVD1521274"></td>
											<td><input type="text" class="form-control" value="https://cinepolis.com/"></td>
											<td><input type="text" class="form-control" value="015521226060"></td>
											<td><input type="text" class="form-control" value="soporte_ef@cinepolis.com"></td>
											<td><input type="text" class="form-control" value="Terciario"></td>
										</tr>
									</tbody>
								</table>
							</div>
				...
				<div id="edit_modalA04" class="modal fade" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header bg-transparent">
								<h5 class="modal-title">Tabla de Editar</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="E04"></td>
											<td><input type="text" class="form-control" value="Jarritos"></td>
											<td><input type="text" class="form-control" value="Mexico"></td>
											<td><input type="text" class="form-control" value="Ciudad de Mexico"></td>
											<td><input type="text" class="form-control" value="Ahuacatitla Numero 96 Colonia Barrio los Reyes Azcapotzalco México, Distrito Federal"></td>
											<td><input type="text" class="form-control" value="NWM9709244"></td>
											<td><input type="text" class="form-control" value="http://www.jarritosmexico.com/"></td>
											<td><input type="text" class="form-control" value="5558994200"></td>
											<td><input type="text" class="form-control" value="datospersonales@agamexico.com.mx"></td>
											<td><input type="text" class="form-control" value="Secundario"></td>
										</tr>
									</tbody>
								</table>
				...
				<div id="edit_modalA05" class="modal fade" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header bg-transparent">
								<h5 class="modal-title">Tabla de Editar</h5>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<tr>
											<td><input type="text" class="form-control" value="E05"></td>
											<td><input type="text" class="form-control" value="Rotoplas"></td>
											<td><input type="text" class="form-control" value="Mexico"></td>
											<td><input type="text" class="form-control" value="Ciudad de Mexico"></td>
											<td><input type="text" class="form-control" value="Delegación Miguel Hidalgo, C.P. 11040, Ciudad de México, México."></td>
											<td><input type="text" class="form-control" value="AWEF244SDE"></td>
											<td><input type="text" class="form-control" value="https://rotoplas.com.mx/"></td>
											<td><input type="text" class="form-control" value="(55)54832950"></td>
											<td><input type="text" class="form-control" value="contactorotoplas@gmail.com"></td>
											<td><input type="text" class="form-control" value="Secundario"></td>
										</tr>
									</tbody>
								</table>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								Se eliminara lo seleccionado, ¿Esta seguro de eso?
							</div>
