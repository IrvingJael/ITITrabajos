			...
			<div class="page-header page-header-light">
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Agregar vacaciones</span>
						</div>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Agregar Vacaciones</h5>
					...
					<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Fecha Final:</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Lugar de vacaciones:</label>
									<div class="col-lg-10">
										<input type="text" class="form-control">
									</div>
								</div>
